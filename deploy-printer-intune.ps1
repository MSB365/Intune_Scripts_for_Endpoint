    ...
    if ($global:logging -eq $true) {
        ...
        if ($global:verboselog -eq $true -and $v -eq $true){
            #Check if Log Entry is marked as verbose      
                ...
                if ($global:logtoEventlog -eq $true) {Write-EventLog –LogName Application –Source global:eventlogSource –EntryType $elogtype –EventID 1 –Message $logstring -ErrorAction
 Stop}
...
# General
    ...
    $PrinterDriver = “CanoniR-ADV_C7260/7204D4"
    #Printer Port Name
    $PrinterPortName = “TCPIP:Hallo”
    #Printer IP Address
    $PrinterIPAddress = "Left bank for purpose of this topic"
